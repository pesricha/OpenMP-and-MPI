...
\begin{enumerate}
    \item They were two less in number. very less information could be extracted from the plots.
...
The observations are listed in \textit{Italics} and the observation in plaintext below the observation.
\\
