...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/MPI_plot.png} % Adjust the width as needed
    \caption{Time taken and speedup values vs num\_processes for N = 5,000,000}
    \label{fig:MPIplot}
\end{figure}
...
\begin{enumerate}
    \item \textbf{\textit{The time taken gets halved (and speedup doubles) for each process doubling}}: \\
    This is 
\end{enumerate}
